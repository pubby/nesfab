...
=== `bus-conflicts` (`-C`) [[opt_bus_conflicts]]
...
[NOTE]
Similar mappers like MHROM can be had using configuration options.
...
[NOTE]
See the standard library file `lib/gtrom.fab`.
...
[NOTE]
See the standard library file `lib/mmc1.fab`.
...
[NOTE]
See the standard library file `lib/mmc3.fab`.
