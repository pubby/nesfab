...
constexpr op_def_t op_defs_table[NUM_NORMAL_OPS] =
{
    ...
    // MVN
    {
        OP(MVN, IMMEDIATE_IMMEDIATE),
        .op_code = 0x54,
        .size = 3,
        .cycles = 7,
        .input_regs = REGF_M | REGF_A | REGF_A_HI | REGF_X | REGF_X_HI | REGF_Y | REGF_Y_HI,
        .output_regs = REGF_M,
        .flags = ASMF_IMPURE,
    },
    ...
    },
    {
        ...
        .size = 4,
        .cycles = 5,
        .input_regs = REGF_A | REGF_C | REGF_M | REGF_X,
        .output_regs = REGF_NZ | REGF_A | REGF_C | REGF_V,
    },
    {
        OP(ADC, INDIRECT_Y_LONG),
        .op_code = 0x77,
        .size = 2,
        .cycles = 6,
        .input_regs = REGF_A | REGF_C | REGF_M | REGF_Y,
        .output_regs = REGF_NZ | REGF_A | REGF_C | REGF_V,
    },
    {
        OP(ADC, STACK_S),
    ...
    },
    {
        ...
        .size = 4,
        .cycles = 5,
        .input_regs = REGF_A | REGF_M | REGF_X,
        .output_regs = REGF_NZ | REGF_C,
        .flags = ASMF_IDEMPOTENT,
    },
    {
        OP(CMP, INDIRECT_Y_LONG),
        .op_code = 0xD7,
        .size = 2,
        .cycles = 6,
        .input_regs = REGF_A | REGF_M | REGF_Y,
        .output_regs = REGF_NZ | REGF_C,
        .flags = ASMF_IDEMPOTENT,
    },
    {
