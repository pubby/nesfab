...
constexpr std::uint16_t FLAG_IN_WORKLIST = 1ull << 2;
constexpr std::uint16_t FLAG_PROCESSED   = 1ull << 3;
constexpr std::uint16_t FLAG_IRREDUCIBLE = 1ull << 4;
constexpr std::uint16_t FLAG_CARRY_KNOWN = 1ull << 5;
constexpr std::uint16_t FLAG_CARRY_SET   = 1ull << 6;
